          ...
          <tbody className="text-sm divide-y divide-gray-100">
            {clientes && clientes.map((c) => (
              <tr key={c.id} className="hover:bg-blue-50/50 transition-colors group">
                ...
                <td className="p-4 font-bold text-gray-500">{c.numeroCliente || "---"}</td>
                <td className="p-4 font-bold text-gray-800">{c.nombre} {c.apellidos}</td>
                ...
                <td className="p-4 text-xs font-medium text-gray-500">{c.fechaNacimiento || "---"}</td>
                <td className="p-4">
                ...
                <td className="p-4 text-xs font-semibold text-gray-500">{c.pagador ? "Sí" : "No"}</td>
              </tr>
            ))}
          </tbody>
        </table>
